...
npm install
3. Database Setup
Create a MySQL database named ev_charging_station_network
Import your database schema (tables, stored procedures, functions, triggers)
...
Optionally add a vehicle during signup
Click "Create account" to register and auto-login
Using the Dashboard
...
Click "Start New Charging Session" button
Enter Vehicle ID, Charger ID, and Energy Consumed
The system will automatically calculate the cost
🎨 UI Features
